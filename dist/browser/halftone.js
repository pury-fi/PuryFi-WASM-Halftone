...
* @returns {Uint8Array}
*/
export function halftone_pixel(src_data, dot_size, dot_res, data_x, data_y, data_w, data_h, rect_x, rect_y, rect_w, rect_h, r, g, b, alpha, bg_r, bg_g, bg_b, bg_alpha, accurate_sampling, cmyk_color_mode) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('halftone_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
