...
* @returns {Uint8Array}
*/
module.exports.halftone_pixel = function(src_data, dot_size, dot_res, data_x, data_y, data_w, data_h, rect_x, rect_y, rect_w, rect_h, r, g, b, alpha, bg_r, bg_g, bg_b, bg_alpha, accurate_sampling, cmyk_color_mode) {
...
const path = require('path').join(__dirname, 'halftone_bg.wasm');
